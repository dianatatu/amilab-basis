...
class MongoWriter(PDU):
    ...
    def __init__(self):
        ...
        # This index makes sure that we only keep records in the measurements
        # database for a single day. We do this in order to avoid filling it.
